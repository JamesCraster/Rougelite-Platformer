...
public:
    ...
    void testTileCollisions(std::vector<sf::RectangleShape*> tileVector){
        ...
        {
            peakVelocity = physicsController.velocity.y;
            physicsController.velocity.y  = 0;
        }
